...
# data_freq = frequency(author_set,122)
# aaaa = count_matrix(author_set,data_freq)
# weight = np.array(aaaa)  
...
# aaaa = regular(author_set,author_num)

data_freq = frequency(author_set,102)
weight = regular(author_set,data_freq)
